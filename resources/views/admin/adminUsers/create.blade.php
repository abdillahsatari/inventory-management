...
@section('content')
    ...
    <div class="col-xl-9 mx-auto">
        <h6 class="mb-0 text-uppercase">Tambah Pengguna</h6>
        <hr />
        <div class="card">
            <div class="card-body">
                <div class="p-4 border rounded">
                    <form action="{{ route("admin.user.store") }}" method="post" class="row g-3 needs-validation" novalidate>
                        @csrf
                        @method("post")
                        <div class="col-md-12">
                            <label for="validationCustom01" class="form-label">Nama Pengguna</label>
                            <input type="text" name="user_name" class="form-control" id="validationCustom01" value="{{ old('user_name') }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="user_username" class="form-control" id="validationCustom02" value="{{ old("user_username") }}" required>
                            <div class="valid-feedback">Looks good!</div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="user_email" class="form-control" id="validationCustom03" value="{{ old("user_email") }}" required>
                            <div class="valid-feedback">Looks good!</div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="user_status" class="single-select js-input-with-plugin form-control" id="user_status" data-rule-required="true" data-msg="Status Pengguna Tidak Boleh Kosong">
                                <option value="" disabled selected>-- Pilih Status Pengguna --</option>
                                <option value="{{ \App\Enums\UserStatusType::ACTIVE() }}">{{ \App\Enums\UserStatusType::ACTIVE() }}</option>
                                <option value="{{ \App\Enums\UserStatusType::INACTIVE() }}">{{ \App\Enums\UserStatusType::INACTIVE() }}</option>
                            </select>
                            <div class="valid-feedback">Looks good!</div>
