        ...
        <div class="card">
            <div class="card-body">
                <div class="p-4 border rounded">
                    <form action="{{ route("admin.product.update", ["id" => $c_product["id"]]) }}" method="post" class="row g-3 needs-validation" novalidate>
                        @csrf
                        @method("post")
                        <div class="col-md-6">
                            <label for="validationCustom01" class="form-label">Nama Produk</label>
                            <input type="text" name="product_name" class="form-control" id="validationCustom01" value="{{ $c_product["name"] }}" required>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="product_price" class="form-control" id="validationCustom02" value="{{ $c_product["price"] }}" required>
                            <div class="valid-feedback">Looks good!</div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="product_point" class="form-control" id="validationCustom03" value="{{ $c_product["point"] }}" required>
                            <div class="valid-feedback">Looks good!</div>
                        ...
                        <div class="col-12">
                            <a href="{{ route("admin.product.index") }}" class="btn btn-light mr-3">Kembali</a>
