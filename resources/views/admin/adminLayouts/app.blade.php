								...
								<div class="dropdown-menu dropdown-menu-end">
									...
									<div class="header-message-list">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{ asset('assets/admin/images/avatars/avatar-2.png') }}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{ asset('assets/admin/images/avatars/avatar-3.png') }}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{ asset('assets/admin/images/avatars/avatar-4.png') }}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{ asset('assets/admin/images/avatars/avatar-5.png') }}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{ asset('assets/admin/images/avatars/avatar-6.png') }}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{ asset('assets/admin/images/avatars/avatar-7.png') }}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{ asset('assets/admin/images/avatars/avatar-8.png') }}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{ asset('assets/admin/images/avatars/avatar-9.png') }}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{ asset('assets/admin/images/avatars/avatar-10.png') }}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{ asset('assets/admin/images/avatars/avatar-11.png') }}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
						   ...
						   <div class="card radius-10 w-100">
							 ...
							 <ul class="list-group list-group-flush review-list">
								<li class="list-group-item bg-transparent">
								  <div class="d-flex align-items-center">
									<img src="{{ asset('assets/admin/images/avatars/avatar-1.png') }}" alt="user avatar" class="rounded-circle" width="55" height="55">
								  <div class="ms-3">
								...
								<li class="list-group-item bg-transparent">
								  <div class="d-flex align-items-center">
									<img src="{{ asset('assets/admin/images/avatars/avatar-2.png') }}" alt="user avatar" class="rounded-circle" width="55" height="55">
								  <div class="ms-3">
								...
								<li class="list-group-item bg-transparent">
								  <div class="d-flex align-items-center">
									<img src="{{ asset('assets/admin/images/avatars/avatar-3.png') }}" alt="user avatar" class="rounded-circle" width="55" height="55">
								  <div class="ms-3">
								...
								<li class="list-group-item bg-transparent">
								  <div class="d-flex align-items-center">
									<img src="{{ asset('assets/admin/images/avatars/avatar-4.png') }}" alt="user avatar" class="rounded-circle" width="55" height="55">
								  <div class="ms-3">
								...
								<li class="list-group-item bg-transparent">
									<div class="d-flex align-items-center">
									  <img src="{{ asset('assets/admin/images/avatars/avatar-9.png') }}" alt="user avatar" class="rounded-circle" width="55" height="55">
									<div class="ms-3">
									  <h6 class="mb-0">Air Pod <small class="ml-4">05.26 PM</small></h6>
									  <p class="mb-0 small-font">Danish Josh : The brand apple is original !</p>
									</div>
								...
								<li class="list-group-item bg-transparent">
								  <div class="d-flex align-items-center">
									<img src="{{ asset('assets/admin/images/avatars/avatar-7.png') }}" alt="user avatar" class="rounded-circle" width="55" height="55">
								  <div class="ms-3">
								...
								<li class="list-group-item bg-transparent">
									<div class="d-flex align-items-center">
									  <img src="{{ asset('assets/admin/images/avatars/avatar-8.png') }}" alt="user avatar" class="rounded-circle" width="55" height="55">
									<div class="ms-3">
									  <h6 class="mb-0">Air Pod <small class="ml-4">05.26 PM</small></h6>
									  <p class="mb-0 small-font">Danish Josh : The brand apple is original !</p>
									</div>
									...
									<tbody>
											...
											<td>
												<div class="d-flex align-items-center">
													<div class="recent-product-img">
														<img src="{{ asset('assets/admin/images/icons/chair.png') }}" alt="">
													</div>
													<div class="ms-2">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<div class="recent-product-img">
														<img src="{{ asset('assets/admin/images/icons/shoes.png') }}" alt="">
													</div>
													<div class="ms-2">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<div class="recent-product-img">
														<img src="{{ asset('assets/admin/images/icons/headphones.png') }}" alt="">
													</div>
													<div class="ms-2">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<div class="recent-product-img">
														<img src="{{ asset('assets/admin/images/icons/idea.png') }}" alt="">
													</div>
													<div class="ms-2">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<div class="recent-product-img">
														<img src="{{ asset('assets/admin/images/icons/user-interface.png') }}" alt="">
													</div>
													<div class="ms-2">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<div class="recent-product-img">
														<img src="{{ asset('assets/admin/images/icons/watch.png') }}" alt="">
													</div>
													<div class="ms-2">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<div class="recent-product-img">
														<img src="{{ asset('assets/admin/images/icons/tshirt.png') }}" alt="">
													</div>
													<div class="ms-2">
