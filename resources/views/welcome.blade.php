...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta property="og:locale" content="id_ID"> <!-- Lokasi atau bahasa situs -->
                    ...
                    <div class="row gx-5 align-items-center">
                        <div class="col-xxl-5">
                            ...
                            <div class="text-center text-xxl-start">
                                <div class="badge bg-gradient-primary-to-secondary text-white mb-4"><div class="text-uppercase">Inventory Management</div></div>
                                <div class="fs-3 fw-light text-muted">Welcome!!</div>
                        ...
                        <div class="col-xxl-7">
                            ...
                            <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                                <div class="profile bg-gradient-primary-to-secondary">
                                    ...
                                    <img class="profile-img" src="{{ asset('assets/public/images/img1.jpg') }}" alt="Profile Picture" />
                                    <div class="dots-1">
                                        <!-- SVG Dots-->
        ...
        <footer class="bg-white py-4 mt-auto">
            <div class="container px-5">
                <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                    <div class="small m-0 text-center" id="date">
                    </div>
                </div>
            </div>
        </footer>
